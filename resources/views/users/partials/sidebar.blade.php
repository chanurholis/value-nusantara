<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ set_active('user.auction-histories') }}"><a class="nav-link" href="{{ route('user.auction-histories') }}"><i class="fas fa-user-friends"></i> <span>Lelang Diikuti</span></a></li>                                    
            ...
            <li class="{{ set_active('user.identity-card') }}"><a class="nav-link" href="{{ route('user.identity-card') }}"><i class="fas fa-id-card"></i> <span>KTP</span></a></li>                        
            ...
            <li><a class="nav-link" href="{{ route('user.trashed') }}"><i class="fas fa-trash-alt"></i> <span>Barang Dihapus</span></a></li>
        </ul>
    </aside>
</div>