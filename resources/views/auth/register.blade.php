                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col">
                                            ...
                                            <input id="email" type="text"
                                                ...
                                                value="{{ old('email') }}" placeholder="surel@contoh.com">
                                            <div class="invalid-feedback">
                                                @error('email')
                                                    {{ $message }}
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="form-group col">
                                            ...
                                            <input id="phone_number" type="tel"
                                                ...
                                                placeholder="Minimal 8-14 Angka" autocomplete="tel-national">
                                            <div class="invalid-feedback">
                                                @error('phone_number')
                                                    {{ $message }}
                                                @enderror
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="term_of_use"
                                                class="custom-control-input @error('term_of_use') is-invalid @enderror"
                                                id="agree">
                                            <label class="custom-control-label" for="agree">Dengan menekan tombol
                                                <b>Daftar</b>, Anda sudah bersedia dan menyetujui <a
                                                    href="{{ route('term-of-use') }}" target="_blank">Syarat dan
                                                    Ketentuan Layanan</a></label>
                                        </div>
                                    </div>
