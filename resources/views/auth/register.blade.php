                            ...
                            @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" autofocus placeholder="Minimal 8-14 Angka">
                                        <div class="invalid-feedback">
                                            @error('domicile') {{ $message }} @enderror
                                        </div>
                                    </div>
