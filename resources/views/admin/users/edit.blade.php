...
@section('title-header', 'Perbarui Pengguna')
...
<div class="row">
    <div class="col-12">
        ...
        @endif
        <div class="card">
            <form action="{{ '/admin/users/' . $model['id'] }}" method="post">
                @method('patch')
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" id="name" value="{{ $model['name'] }}" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Lengkap">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" id="email" name="email" value="{{ $model['email'] }}" class="form-control @error('email') is-invalid @enderror" placeholder="surel@contoh.com">
                            <div class="invalid-feedback">
