...
<div id="app">
    ...
    <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <div class="search-element">
            ...
            <div class="search-item">
                <a href="#">
                <img class="mr-3 rounded" width="30" src="http://localhost/TEMPLATE/stisla/assets/img/products/product-3-50.png" alt="product">
                oPhone S9 Limited Edition
                </a>
            </div>
            <div class="search-item">
                <a href="#">
                <img class="mr-3 rounded" width="30" src="http://localhost/TEMPLATE/stisla/assets/img/products/product-2-50.png" alt="product">
                Drone X2 New Gen-7
                </a>
            </div>
            <div class="search-item">
                <a href="#">
                <img class="mr-3 rounded" width="30" src="http://localhost/TEMPLATE/stisla/assets/img/products/product-1-50.png" alt="product">
                Headphone Blitz
                </a>
            </div>
            <div class="search-header">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, Chacha Nurholis</div></a>
