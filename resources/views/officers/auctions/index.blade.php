...
@section('title', '| Permintaan Lelang')

@section('title-header', 'Permintaan Lelang')
...
<div class="card">
    <div class="card-header">
        <h4>Permintaan Lelang <span>({{ $auctions->count() }})</span></h4>
        <div class="card-header-action">
            <button class="btn btn-danger" id="modal-5">Ekspor <i class="fas fa-file-export"></i></button>
        </div>
    </div>
    <!-- Export Modal -->
    <form class="modal-part" id="modal-login-part" action="" method="post">
        @csrf
            ...
            <table class="table table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ '/officer/auction-request/' . $auction['id'] }}" class="btn btn-info"><i class="fa fa-search"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
